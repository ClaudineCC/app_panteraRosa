...
const CorpoEBanho: React.FC<Props> = ({ navigation }) => {
  // no searchBar
  interface Produto {
    id: number;
    titulo: string;
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <Text> Você esta na categoria : CORPO E BANHO </Text>

        <View>
          <Card
            idProduto={1} // Add the idProduto property
        ...
        <View style={styles.bannerfinal}>
          <Image
            source={require("../assets/images/img06.png")}
            style={styles.image}
          />
        </View>
