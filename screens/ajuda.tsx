      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.canaisGeral}>
          ...
          <View style={styles.canais}>
            ...
            <Text style={styles.texto} onPress={abrirWhatsApp}>
              WhattSap (21) 91111-1111
            </Text>
          </View>

          <View style={styles.canais}>
            <Icon name=" phone " size={20} style={styles.icone} />
            <Text style={styles.texto} onPress={abrirTelefone}>
          ...
          <View style={styles.texto}>
            <Text>
              Horário de Atendimento: Seg à Sex 8hs as 20h Sab 8h às 14h
            </Text>
          </View>
        </View>
